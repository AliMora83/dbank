...
export default function InvestMarket() {
  return (
    <div className="border rounded-lg p-2 my-10">
      {/* Invest */}
      <div className="text-slate-500">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="flex flex-col items-center bg-slate-100 rounded-lg p-2  transform hover:scale-105 transition-transform ease-in-out duration-300 hover:border-b-2 hover:border-primary-100 hover:text-primary-100">
