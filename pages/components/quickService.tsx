    ...
    <div>
      ...
      <div className="text-slate-500  my-10">
        ...
        <div className="flex items-center justify-between w-[80%] mx-auto">
          <Link href="/transact">
            <div className="flex flex-col items-center bg-slate-100 rounded-lg py-4 px-8  transform hover:scale-110 transition-transform ease-in-out duration-300 hover:border-b-2 hover:border-primary-100 hover:text-primary-100">
